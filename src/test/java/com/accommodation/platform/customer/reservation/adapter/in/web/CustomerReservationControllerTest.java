...
class CustomerReservationControllerTest {
    ...
    private org.springframework.restdocs.payload.ResponseFieldsSnippet reservationResponseFields() {
        ...
        return responseFields(
                ...
                fieldWithPath("data.member_id").description("회원 ID"),
                ...
                fieldWithPath("data.hourly_usage_minutes").description("대실 이용 시간(분)"),
                fieldWithPath("data.guest_name").description("투숙객 이름"),
                fieldWithPath("data.guest_phone").description("투숙객 연락처"),
                fieldWithPath("data.guest_email").description("투숙객 이메일").optional(),
