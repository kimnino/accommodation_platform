...
public interface ExtranetRegisterAccommodationUseCase {
    ...
    record RegisterAccommodationCommand(Long partnerId, String name, String type,
                                        String fullAddress, double latitude, double longitude,
                                        String locationDescription, String checkInTime,
                                        String checkOutTime, List<String> supportedLocales,
                                        List<TranslationCommand> translations) {}


    record TranslationCommand(String locale, String name, String fullAddress,
                              String locationDescription, String introduction,
                              String serviceAndFacilities, String usageInfo,
